                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapseOne" class="accordion-body collapse ">
                            <div class="accordion-inner">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Tên dự án<br>(Tiếng Hàn): </label>
                                    <div class="col-sm-10">
                                        <input type="text" required name="pro_ten_kr" class="form-control" value="{{ $project_detail->pro_ten_kr }}">
                                    </div>
                                </div>
                                <hr/>

                                <div class="form-group last">
                                    <label class="control-label col-md-2">Show MGD team</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="pro_mgd_team" @if($project_detail->pro_mgd_team == 1) checked="checked" @endif/>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" red name="pro_owner_en" class="form-control" value="{{ $project_detail->pro_owner_en }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Complete time: </label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Floor area (m2):</label>
                                    <div class="col-sm-4">
                                        <input type="text"  name="pro_area" class="form-control" value="{{ $project_detail->pro_area }}">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Land area (m2): </label>
                                    <div class="col-sm-4">
                                        <input type="text"  name="pro_land_area" class="form-control" value="{{ $project_detail->pro_land_area }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4 col-sm-3">
                                        <select id="procat-main" required class="alert alert-primary" name="pro_status" style="width:200px; border: 1.5px solid #dbdbdb;">
                                            ...
                                            <option value="unknow" @if ($project_detail->pro_status== 'unknow') selected="selected" @endif>UNKNOW</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.html#collapseTwo">
                                <em class="glyphicon glyphicon-chevron-right icon-fixed-width"></em>Hình ảnh dự án
                            </a>
                        </div>
                            ...
                            <div class="accordion-inner">
                                    ...
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="@if($project_detail->pro_thumb == '') {{ asset('public/noimage.jpg') }} @else {{ asset('public/upload/product/'.$project_detail->pro_thumb) }} @endif" class="image_output" style="width:100%; height:100%" alt="" />
                                            </div>
										...
										<a href="{{ asset('admin/project/blank/avatar/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div>
                                ...
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-10">
										...
										<a href="{{ asset('admin/project/blank/thumb/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div>
                                ...
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-10">
										...
										<a href="{{ asset('admin/project/blank/banner/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div>
                                ...
                                <h3 class="text-center">Hình catalouge</h3>
                                <p class="text-center">
                                    <img src="{{ asset('public/upload/template/detail-admin.jpg') }}" alt="">
                                </p>
                                    ...
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="bannertop_img_1_output" src="@if($project_detail->pro_catalouge_1 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_1) }} @else {{ asset('public/noimage.jpg') }} @endif " alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="bannertop_img_1_input" type="file" name="pro_catalouge_1" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge1/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="bannertop_img_2_output" src="@if($project_detail->pro_catalouge_2 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_2) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="bannertop_img_2_input" type="file" name="pro_catalouge_2" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge2/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 3:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="bannertop_img_3_output" src="@if($project_detail->pro_catalouge_3 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_3) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="bannertop_img_3_input" type="file" name="pro_catalouge_3" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge3/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 4:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="bannertop_img_4_output" src="@if($project_detail->pro_catalouge_4 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_4) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="bannertop_img_4_input" type="file" name="pro_catalouge_4" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge4/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 5:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="whyus_icon_1_output" src="@if($project_detail->pro_catalouge_5 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_5) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="whyus_icon_1_input" type="file" name="pro_catalouge_5" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge5/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 6:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="whyus_icon_2_output" src="@if($project_detail->pro_catalouge_6 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_6) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="whyus_icon_2_input" type="file" name="pro_catalouge_6" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge6/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 7:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="whyus_icon_3_output" src="@if($project_detail->pro_catalouge_7 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_7) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="whyus_icon_3_input" type="file" name="pro_catalouge_7" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge7/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2">Hình 8:</label>
                                    <div class="col-md-10">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 185px; height: auto;">
                                                <img id="whyus_icon_4_output" src="@if($project_detail->pro_catalouge_8 != null) {{ asset('public/upload/product/'.$project_detail->pro_catalouge_8) }} @else {{ asset('public/noimage.jpg') }} @endif" alt="" style="width:100%; height:100%"/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                            <div>
                                                <span class="btn btn-theme02 btn-file">
                                                    <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình ảnh</span>
                                                    <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                    <input id="whyus_icon_4_input" type="file" name="pro_catalouge_8" class="default" />
                                                </span>
                                                <a href="advanced_form_components.html#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                                            </div>
                                        </div>
										...
										<a href="{{ asset('admin/project/blank/catalouge8/'.$project_detail->pro_id) }}">
											<input style="width:150px;" type="button" class="btn btn-danger" value="Delete photo">
										</a>
                                    </div>
                                </div><br/><br/>
