...
@section('title', 'Cập nhật timeline') 
...
<section id="main-content">
    ...
    <section class="wrapper">
        ...
        <div class="row content-panel">
            <h2 class="centered">Cập nhật timeline</h2>
            <div class="col-md-12 mt mb">
                ...
                <form method="post" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="date" required name="event_date" class="form-control" value="{{ $timeline_item->event_date }}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="{{ asset('public/upload/timeline/'.$timeline_item->event_img) }}" class="image_output" style="width:100%; height:100%" alt="" />
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required name="event_title_vi" class="form-control" value="{{ $timeline_item->event_title_vi }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required name="event_title_en" class="form-control" value="{{ $timeline_item->event_title_en }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required name="event_title_zh" class="form-control" value="{{ $timeline_item->event_title_zh }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required name="event_title_ja" class="form-control" value="{{ $timeline_item->event_title_ja }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required name="event_title_kr" class="form-control" value="{{ $timeline_item->event_title_kr }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="event_description_vi" id="" style="width:100%;" rows="10">{{ $timeline_item->event_description_vi }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="event_description_en" id="" style="width:100%;" rows="10">{{ $timeline_item->event_description_en }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="event_description_zh" id="" style="width:100%;" rows="10">{{ $timeline_item->event_description_zh }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="event_description_ja" id="" style="width:100%;" rows="10">{{ $timeline_item->event_description_ja }}</textarea>
                        </div>
                    </div>
