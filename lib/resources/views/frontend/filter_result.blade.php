            ...
            <section id="topWorks" class="g-py-80">
                ...
                <div id="intro-project" class="container-fluid text-center g-max-width-950">
                    <div class="text-uppercase g-brd-primary">
                        <h3 id="project-title" class="h3 g-letter-spacing-5 g-font-size-24 g-font-weight-400 g-color-primary" style="">@lang('messages.project_filter_result_title')</h3>
                        <div id="intro-text" class="text-center col-lg-8 col-md-8 offset-md-2 text-center">
                            <p>
                                <strong>{{ $project_count }}</strong> @lang('messages.project_filter_result_text')@if( $project_count>1 && Config::get('app.locale') == 'en' )s @endif
                            </p>
                        </div>
                    </div>
                </div>
